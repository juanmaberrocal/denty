...
class homePageHighlight {
	private static $table_name = 'home_page_highlights';
	...
	===============================*/
	// get home page highlights from a specific office
	function getFromOffice($office_domain, $limit = 3, $cols = array(), $ext_cols = array()){
	...
	// get home page highlights from a specific home page
	function getFromHomePage($home_page_id, $limit = 3, $cols = array(), $ext_cols = array()){
		// if no specific columns were passed use defined public cols
		if (empty($cols)){
			$cols = self::$columns_public;
		}
